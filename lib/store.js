...
const DEFAULT_CONFIG = {
  ...
  key_dates: [
    { key: 'open', date: '2026-09-17', label: 'Submissions open', detail: 'Portal opens to all operating companies' },
    { key: 'deadline', date: '2026-10-02', label: 'Submission deadline', detail: '11:59 PM ET' },
